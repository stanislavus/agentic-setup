...
- **Global scope**: `/Users/stanislavus/Developer/agentic-setup/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/stanislavus/Developer/agentic-setup/.claude/notes/`)
...
2. Glob `/Users/stanislavus/Developer/agentic-setup/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/stanislavus/Developer/agentic-setup/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/stanislavus/Developer/agentic-setup/.claude/notes/` — works in any directory
