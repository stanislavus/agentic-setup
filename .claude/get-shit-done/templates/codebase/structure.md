...
- Usage: Reference from command with `@/Users/stanislavus/Developer/agentic-setup/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/stanislavus/Developer/agentic-setup/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/stanislavus/Developer/agentic-setup/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
