...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/stanislavus/Developer/agentic-setup/.claude
                  → checks /Users/stanislavus/Developer/agentic-setup/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/stanislavus/Developer/agentic-setup/.claude/get-shit-done
                  → writes to /Users/stanislavus/Developer/agentic-setup/.claude/get-shit-done/hooks/
...
@/Users/stanislavus/Developer/agentic-setup/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/stanislavus/Developer/agentic-setup/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/stanislavus/Developer/agentic-setup/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/stanislavus/Developer/agentic-setup/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/stanislavus/Developer/agentic-setup/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
