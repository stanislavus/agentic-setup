...
<reference>
@/Users/stanislavus/Developer/agentic-setup/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/stanislavus/Developer/agentic-setup/.claude/get-shit-done/references/user-profiling.md` to load:
