...
- Usage: Reference from command with `@/Users/stanislavus/Developer/agentic-setup/.opencode/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/stanislavus/Developer/agentic-setup/.opencode/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/stanislavus/Developer/agentic-setup/.opencode/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
